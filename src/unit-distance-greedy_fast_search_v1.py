...
def run_iteration_gpu(discovered_points, discovered_set, max_denominator, device, max_broadcast_elements=15_000_000):
    """
...
if __name__ == "__main__":
    ...
    for iteration in range(1, NUM_ITERATIONS + 1):
        ...
        while not goal_achieved:
            ...
            new_points, connections = run_iteration_gpu(discovered_points, discovered_set, current_max_denom, device)
            ...
            num_points = len(discovered_points)

            print(f"\n Expanding rational fraction space to max_denominator = {current_max_denom}:")
            ...
            if denom_idx >= len(DENOMINATORS):
                print(f"\n[WARNING] Reached end of curated DENOMINATORS list.")
